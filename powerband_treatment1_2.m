% Perform for treatment 1 media 1 - 10

% change the media name, the index in n according to participant number 
...
for k = 1:10 
    ...
    for i = 1:5
        ...
        Summary_final((participant-1)*40+k,2*i+3) = array2table(alpha);
        Summary_final((participant-1)*40+k,2*i+4) = array2table(theta);
     end
