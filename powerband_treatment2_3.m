% Perform for treatment 2 media 1 - 10
...
for k = 1:10 
    ...
    for i = 1:5
        ...
        Summary_final((participant-1)*40+10+k,2*i+3) = array2table(alpha);
        Summary_final((participant-1)*40+10+k,2*i+4) = array2table(theta);
     end
